...
from ltr.models.head.corner_coarse_fcn import Corner_Predictor
from ltr.models.head.mask_fcn import Mask_Predictor_fine
...
@model_constructor
def SEcm_resnet34(backbone_pretrained=True,
                  used_layers=('layer3',),
                  pool_size=None,
    ...
    # multiple heads
    corner_head = Corner_Predictor(inplanes=pool_size*pool_size, output_sz=output_sz)  # 64
    mask_head = Mask_Predictor_fine(output_sz*16)
