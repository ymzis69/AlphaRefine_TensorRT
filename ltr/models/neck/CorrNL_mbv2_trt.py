    ...
    def fuse_feat(self, feat2, convert_trt=False):
        ...
        if self.use_post_corr:
            if not convert_trt:
                ...
                torch.save(post_corr_trt.state_dict(), 'trt_models/trt_model_RF_RF_mbv2/neck_postcorr_trt.pth')
        ...
        if not convert_trt:
            ...
            torch.save(channel_attention_trt.state_dict(), 'trt_models/trt_model_RF_RF_mbv2/channel_attention_trt.pth')
