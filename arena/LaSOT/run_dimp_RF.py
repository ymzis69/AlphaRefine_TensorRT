...
# python3 arena/LaSOT/run_dimp_RF.py  --dataset UAV123
# base tracker
...
def main():
    # create tracker dimp super_dimp
    ...
    '''Refinement module'''
    RF_module = RefineModule(refine_path, selector_path, search_factor=sr, input_sz=input_sz)  #2
    ...
    for v_idx, video in enumerate(dataset):
        ...
        for idx, (img, gt_bbox) in enumerate(video):
            ...
            if idx == 0:
                ...
                gt_bbox_ = [cx-(w-1)/2, cy-(h-1)/2, w, h]  # left, top, w, h
                '''Initialize'''
