...
class RefineModule(object):
    def __init__(self, refine_net_dir, selector=None, search_factor=2.0, input_sz=256, convert_trt=False):
        self.refine_network = self.get_network(refine_net_dir)   #171
